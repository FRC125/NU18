...
public class LeftSideCloseScaleAuto extends CommandGroup {
    Command driveToFarSwitch = new DrivePathCmd(LeftSideCloseScalePaths.toFarSwitchLine);
    Command driveSPathToScale = new DrivePathCmd(LeftSideCloseScalePaths.sPathToScale);
