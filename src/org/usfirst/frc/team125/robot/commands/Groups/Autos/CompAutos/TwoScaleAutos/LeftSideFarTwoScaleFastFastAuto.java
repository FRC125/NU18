...
public class LeftSideFarTwoScaleFastFastAuto extends CommandGroup {
    Command intakeDown = new IntakeDownCmd();
    Command secureCube = new SecureCubeCmdGrp();
    Command liftElevatorToScale = new AutoLiftCmdGrp(0.5, CubeLift.Positions.ScoreScale);
    Command driveToScale = new DrivePathCmd(LeftSideFarTwoScalePaths.toScale, false);
    ...
    public LeftSideFarTwoScaleFastFastAuto() {
