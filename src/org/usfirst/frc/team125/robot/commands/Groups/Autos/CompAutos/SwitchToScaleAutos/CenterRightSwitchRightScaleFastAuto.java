...
public class CenterRightSwitchRightScaleFastAuto extends CommandGroup {
    Command intakeDown = new IntakeDownCmd();
    Command secureCube = new SecureCubeCmdGrp();
    Command liftElevator = new AutoLiftCmdGrp(0.1, CubeLift.Positions.ScoreSwitch);
    Command driveToSwitch = new DrivePathCmd(CenterRightSwitchRightScalePaths.toSwitch, false);
    Command scoreCube = new ScoreCmdGrp();
    Command bringEleToIntake = new RunToPositionMotionMagicCmd(CubeLift.Positions.Intake);
    Command driveBackToLine = new DrivePathReverseCmd(CenterRightSwitchRightScalePaths.reverse_goBack, false);
    Command driveToCube = new DrivePathCmd(CenterRightSwitchRightScalePaths.toCube, false);
    Command intakeCube = new IntakeCmdGrp();
    Command backOffCube = new DrivePathReverseCmd(CenterRightSwitchRightScalePaths.reverse_backOffCube, false);
    Command liftElevatorAgain = new RunToPositionMotionMagicCmd(CubeLift.Positions.ScoreSwitch);
    Command driveToScale = new DrivePathCmd(CenterRightSwitchRightScalePaths.toScale, false);


    public CenterRightSwitchRightScaleFastAuto() {
        /*
