...
public class CenterRightSwitchRightScaleAuto extends CommandGroup {
    ...
    Command driveToSwitch = new DrivePathCmd(CenterRightSwitchRightScalePaths.toSwitch);
    Command scoreCube = new ScoreCmdGrp();
    Command bringEleToIntake = new RunToPositionMotionMagicCmd(CubeLift.Positions.Intake);
    Command driveBackToLine = new DrivePathReverseCmd(CenterRightSwitchRightScalePaths.reverse_goBack);
    Command driveToCube = new DrivePathCmd(CenterRightSwitchRightScalePaths.toCube);
    Command intakeCube = new IntakeCmdGrp();
    Command backOffCube = new DrivePathReverseCmd(CenterRightSwitchRightScalePaths.reverse_backOffCube);
    Command liftElevatorAgain = new RunToPositionMotionMagicCmd(CubeLift.Positions.ScoreSwitch);
    Command driveToScale = new DrivePathCmd(CenterRightSwitchRightScalePaths.toScale);
