...
public class RightSideFarScaleFarSwitchAuto extends CommandGroup {
    ...
    Command driveToScale = new DrivePathCmd(RightSideFarScaleFarSwitchPaths.toScale, true);
    Command scoreCube = new ScoreCmdGrp();
    Command bringElevatorToIntake = new RunToPositionMotionMagicCmd(CubeLift.Positions.Intake);
    Command driveToSwitchA = new DrivePathReverseCmd(RightSideFarScaleFarSwitchPaths.reverse_kTurnToSwitch1A, true);
    Command intakeCube = new IntakeCmdGrp();
    Command driveToSwitchB = new DrivePathCmd(RightSideFarScaleFarSwitchPaths.kTurnToSwitch1B, true);
