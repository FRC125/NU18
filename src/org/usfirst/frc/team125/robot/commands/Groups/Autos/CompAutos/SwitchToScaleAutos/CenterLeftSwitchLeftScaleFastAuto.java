...
import org.usfirst.frc.team125.robot.util.Paths.CompPaths.CenterSwitchToScale.CenterLeftSwitchLeftScalePaths;

public class CenterLeftSwitchLeftScaleFastAuto extends CommandGroup {
    Command intakeDown = new IntakeDownCmd();
    Command secureCube = new SecureCubeCmdGrp();
    Command liftElevator = new AutoLiftCmdGrp(0.1, CubeLift.Positions.ScoreSwitch);
    Command driveToSwitch = new DrivePathCmd(CenterLeftSwitchLeftScalePaths.toSwitch, false);
    Command scoreCube = new ScoreCmdGrp();
    Command bringEleToIntake = new RunToPositionMotionMagicCmd(CubeLift.Positions.Intake);
    Command driveBackToLine = new DrivePathReverseCmd(CenterLeftSwitchLeftScalePaths.reverse_goBack, false);
    Command driveToCube = new DrivePathCmd(CenterLeftSwitchLeftScalePaths.toCube, false);
    Command intakeCube = new IntakeCmdGrp();
    Command backOffCube = new DrivePathReverseCmd(CenterLeftSwitchLeftScalePaths.reverse_backOffCube, false);
    Command liftElevatorAgain = new RunToPositionMotionMagicCmd(CubeLift.Positions.ScoreSwitch);
    Command driveToScale = new DrivePathCmd(CenterLeftSwitchLeftScalePaths.toScale, false);


    public CenterLeftSwitchLeftScaleFastAuto() {
        /*
