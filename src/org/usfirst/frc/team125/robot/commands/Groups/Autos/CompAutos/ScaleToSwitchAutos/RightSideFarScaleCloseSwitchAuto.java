...
public class RightSideFarScaleCloseSwitchAuto extends CommandGroup {
    ...
    Command driveToScale = new DrivePathCmd(RightSideFarScaleCloseSwitchPaths.toScale, true);
    Command scoreCube = new ScoreCmdGrp();
    Command bringElevatorToIntake = new RunToPositionMotionMagicCmd(CubeLift.Positions.Intake);
    Command driveToSwitchA = new DrivePathReverseCmd(RightSideFarScaleCloseSwitchPaths.reverse_kTurnToSwitch1A, true);
    Command intakeCube = new IntakeCmdGrp();
    Command driveToSwitchB = new DrivePathCmd(RightSideFarScaleCloseSwitchPaths.kTurnToSwitch1B, true);
